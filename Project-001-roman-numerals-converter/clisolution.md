...
pip3 install flask
cd /home/ec2-user
FOLDER="https://raw.githubusercontent.com/sarvsp/AWS-Portfolio-Projects/main/Project-001-roman-numerals-converter"
wget ${FOLDER}/app.py
...
```
```bash
aws ec2 run-instances --image-id $LATEST_AMI --count 1 --instance-type t2.micro --key-name newkeypair --security-groups roman_numbers_converter_sec_grp --tag-specifications 'ResourceType=instance,Tags=[{Key=Name,Value=roman_numbers}]' --user-data file:///home/ec2-user/userdata.sh
or
